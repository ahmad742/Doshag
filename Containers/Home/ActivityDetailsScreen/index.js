      ...
      .then(
        function (response) {
          ...
          this.setState({
            id: mainResponse.id,
            name_In_English:
              lang == 'en' ? mainResponse.eng_name : mainResponse.arabic_name,
    ...
    return (
      ...
      <View
        ...
        <Header
          ...
          headerText={this.state.name_In_English}
                ...
                <>
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {Preference.get('currency') + " " + item.total_price}
                    </Text>
                  </View>
                  <View
                    style={{
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {Preference.get('currency') + " " + item.down_payment}
                    </Text>
                  </View>
                  <View
                    style={{
                    ...
                    <Text
                      ...
                      {(item.total_price - item.down_payment).toFixed(2)}
                    </Text>
                  </View>
